...
public class LoginRequest {
    ...
    String searchUrl = "http://ec2-52-4-197-144.compute-1.amazonaws.com:8080/oauth/token";
    ...
    public void sendStringRequest(final String userName,  final String password) {
        ...
        jsonObject.addProperty("scope", "read write");
        jsonObject.addProperty("client_secret", "mySecretOAUthSecret");
        jsonObject.addProperty("client_id", "eadateapp");
