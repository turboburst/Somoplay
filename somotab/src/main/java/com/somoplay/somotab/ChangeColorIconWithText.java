...
public class ChangeColorIconWithText extends View
{
	...
	public void refresh(){
		...
		for (int i = 0; i < n; i++)
		{
			...
			if (attr == R.styleable.ChangeColorIconWithText_tab_icon){
				BitmapDrawable drawable = (BitmapDrawable) typedArray.getDrawable(attr);
				//mIconBitmap = drawable.getBitmap();
			}
			else if(attr == R.styleable.ChangeColorIconWithText_tab_color ){
				//mColor = typedArray.getColor(attr, 0xFF45C01A);
			}
			else if(attr == R.styleable.ChangeColorIconWithText_tab_text ){
				//mText = typedArray.getString(attr);
			}
			else if(attr == R.styleable.ChangeColorIconWithText_tab_text_size ){
